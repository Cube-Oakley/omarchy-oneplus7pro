...
cp "$ROOT"/overlay/mobile/{DrawerMotion,PreviewGestures,EdgeGestures,HeldPreview,DrawerPull,TouchTextField,KeyboardDismiss,NotificationGroups,CrtPhases}.qml "$TEST_DIR/"
