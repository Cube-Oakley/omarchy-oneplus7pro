...
cp "$ROOT"/overlay/mobile/{DrawerMotion,PreviewGestures,EdgeGestures,LeftBack,HeldPreview,DrawerPull,TouchTextField,KeyboardDismiss,NotificationGroups,CrtPhases,SnapPager,VolumeGroupSlider}.qml "$TEST_DIR/"
