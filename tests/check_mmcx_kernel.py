...
HEADER = ROOT / 'devices/oneplus7pro/kernel/power/rpmhpd-mmcx-sleep-test.h'
...
cx_header = (ROOT / 'devices/oneplus7pro/kernel/power/rpmhpd-cx-sleep-test.h').read_text().split('DEFINE_DEBUGFS_ATTRIBUTE')[0].replace('#include <linux/debugfs.h>', '')
