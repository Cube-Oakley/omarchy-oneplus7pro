...
subprocess.run([str(kernel / 'scripts/config'), '--file', str(kernel / '.config'),
                ...
                '--set-str', 'LOCALVERSION', '-pixel-display16' if a.display_timing else ('-pixel-gpu15' if a.gpu else ('-pixel-power14' if a.acpm else ('-pixel-drm11' if a.drm else ('-pixel-net10' if a.usb_network else '-pixel-shell9')))),
