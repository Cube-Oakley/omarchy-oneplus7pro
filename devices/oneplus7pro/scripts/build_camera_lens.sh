...
# our ak7375.c, which we power with its sensor) and the actuator
# identification overlay. Needs the modules
...
patch -s -p4 -d "$WORK/drivers" < "$SRC/ak7375-power-with-sensor.patch"
