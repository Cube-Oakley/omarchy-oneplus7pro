...
- `devices/oneplus7pro/camera/libcamera/s5k3m5.yaml`, in libcamera-guacamole
...
3. The ultra-wide (Sony IMX481 on CCI1, CSIPHY3), then the pop-up front
   camera (Sony IMX471 on CCI1, CSIPHY2) with its motor and hall sensors, the
   motor only with the user present.
