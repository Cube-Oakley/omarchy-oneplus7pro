...
cp "$ROOT/devices/oneplus7pro/kernel/power/rpmhpd-cx-sleep-test.h" "$SRC/drivers/pmdomain/qcom/"
...
cp "$ROOT/devices/oneplus7pro/kernel/power/rpmhpd-cx-sleep-test.h" "$OUT/"
