...
mkdir -p "$WORK" "$OUT"
cp "$ROOT/devices/oneplus7pro/kernel/power/powerkey_overlay.c" "$WORK/"
dtc -@ -I dts -O dtb "$ROOT/devices/oneplus7pro/kernel/power/guacamole-powerkey.dts" -o "$OUT/guacamole-powerkey.dtbo"
