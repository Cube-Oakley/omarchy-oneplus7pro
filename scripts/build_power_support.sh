...
sed 's/powerkey/power_support/g; s/power-key/power-support/g; s/PM8150 power-key/power support/g' \
    "$ROOT/devices/oneplus7pro/kernel/power/powerkey_overlay.c" > "$WORK/power_support.c"
cp "$ROOT/devices/oneplus7pro/kernel/power/guacamole-power-support.dts" "$WORK/power-support.dts"
